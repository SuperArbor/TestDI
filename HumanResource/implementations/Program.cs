...
//            //var company = new Company("Huawei", new List<IPerson>
//            //{
//            //    new Worker("yang", "male", 15, company)
//            //}) ;
...
//            //company.AddMember(new Worker("Yang", "male", 18, company));
//            //company.AddMember(new Worker("Feng", "male", 14, company));
